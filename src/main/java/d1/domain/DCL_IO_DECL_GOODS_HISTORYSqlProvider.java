...
public class DCL_IO_DECL_GOODS_HISTORYSqlProvider {

    public String insertSelective(DCL_IO_DECL_GOODS_HISTORY record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("DCL_IO_DECL_GOODS_HISTORY");
