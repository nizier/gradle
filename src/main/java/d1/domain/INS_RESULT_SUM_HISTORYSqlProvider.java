...
public class INS_RESULT_SUM_HISTORYSqlProvider {

    public String insertSelective(INS_RESULT_SUM_HISTORY record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("INS_RESULT_SUM_HISTORY");
    ...
    public String updateByPrimaryKeySelective(INS_RESULT_SUM_HISTORY record) {
        SQL sql = new SQL();
        sql.UPDATE("INS_RESULT_SUM_HISTORY");
