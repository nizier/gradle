...
@RestController
public class QuestionStateReportController {
    ...
    @RequestMapping(value = "/questionStateReport/get", method = RequestMethod.GET)
    public List<QuestionStateReport_Res_Vm> Get(QuestionStateReport_Get_Vm model)
    {
...
//        }
        ...
        List<QuestionStateReport_Res_Vm> listResVm= questionMapper.getQuestionStateReport(model);
        return listResVm;
    }

    @RequestMapping(value = "/questionStateReport/list", method = RequestMethod.GET)
    public Question_Res_Get_Vm list(QuestionStateReport_Get_Vm model)
    {
        ...
        List<QUESTION> listResVm= questionMapper.getQuestionStateReportList(model);
        int count=questionMapper.getQuestionStateReportListCount(model);
